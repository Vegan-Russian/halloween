...
{
    id: 2023-93,                                               // ID нормер рецета. Вначале год. Идет по порядку сверху вниз. Пишем на единицу больше, чем в последнем рецепте.
                                                               // В этом примере последний добавленный рецепт был с id 2023-92, тогда у нашего будет 2023-93.
    title: "Название рецепта",                                 // Название рецепта.
    image: "./images/recipes/2023/for_test_2023.webp",         // Путь до фотографии блюда. Выглядит как:
                                                               // ./images/recipes/2023/НАВЗАНИЕ КАРТИНКИ.webp
                                                               // 1. Разрешение всегда .webp, даже есть у вас фото.png или .jpg, не важно, тут пишем .webp
                                                               // 2. Не забудте сам файл положить в папку с проектом. У нас фото блюд храняться в:
                                                               // halloween.veganrussian.ru/src/images/recipes/2023/НАВЗАНИЕ ФАЙЛА КАРТИНКИ.webp
    author: "Мой телеграм",                                    // Название ссылки на соц.сеть или сайт автора рецепта. Если нет, пишес: author: "",
    authorLink: "https://t.me/pasha_os",                       // Ссылка на соц.сеть или сайт автора рецепта. Если нет, пишес: authorLink: "",
    year: 2023,                                                // Год конкурса
    description: [                                             // Описание блюда
      "Что в голове у тыквы?",                                 //
      "Уткуси и узнаешь",                                      //
    ],                                                         //
    ingredients: [                                             // Ингридиенты блюда (точки в начале строки подставляются сами)
      "Тыква",                                                 //
      "Грибы",                                                 //
    ],                                                         //
    category: "Закуска",                                       // Катигория блюда
    steps: [                                                   // Инструкция по проготовлению (порядковые номера шагов подставляются сами)
...
export const actualRecipes = [
  {
    ...
    author: "pashka",
    authorLink: "https://t.me/pasha_os",
    year: 2023,
    description: [
      "Она тут ненадолго :). Что в голове у тыквы? Приготовьтесь к вопросам: \"Это еда или искусство?\" и \"Съедобно ли это приведение?\"",
    ],
    ingredients: [
      "Тыква",
      "Грибная неопредленность",
      "Молодой призрак",
    ],
    category: "Закуска",
    steps: [
      "С помощью ножа дайте понять тыкве, что она голова, в которой ничего нет.",
      "Налейте в тыкву грибной соус.",
      "Позовите молодого призрака. Лучше бывшего психолога.",
      "Соврите ему(или нет), что тыква думает о нем неприличные вещи.",
    ],
  },
  {
    id: "2023-2",
    ...
    year: 2023,
    description: [
      "Универсальный кошмарный рецепт для всех айти-студентикс.",
    ],
    ingredients: [
      "1 контест",
      "1 дедлайн завтра",
    ...
    steps: [
      "Откройте расписание.",
      "Заметьте там дедлайн на завтра.",
      "Отправьте решение.",
