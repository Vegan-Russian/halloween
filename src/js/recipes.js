...
ПРИМЕР РЕЦЕПТА:
{
    id: "2023-93",                                             // Идет по порядку сверху вниз. Пишем год + число на единицу больше, чем в последнем рецепте.
    ...
    year: 2023,                                                //
    description: [                                             // Строки отделяются друг от друга кавычкими с запятой: "строка1", "строка2",
      "Что в голове у тыквы?",                                 //
      "Уткуси и узнаешь",                                      //
    ],                                                         //
    ingredients: [                                             // Буллеты(•) подставляются на сайте сами
      "Тыква",                                                 //
      "Грибы",                                                 //
    ],                                                         //
    category: "Закуска",                                       //
    steps: [                                                   // Порядковые номера подставляются на сайте сами
