...
{
    id: 93,                                                    // ID нормер рецета. Идет по порядку сверху вниз. Пишем на единицу больше, чем в последнем рецепте.
                                                               // В этом примере последний добавленный рецепт был с id 92, тогда у нашего будет 93.
